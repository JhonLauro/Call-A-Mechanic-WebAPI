...
public class GlobalExceptionHandler {
    ...
    private HttpStatus mapCodeToStatus(String code) {
        return switch (code) {
            ...
            case "AUTH-004"   -> HttpStatus.BAD_REQUEST;
            case "AUTH-005"   -> HttpStatus.FORBIDDEN;
            case "AUTH-006"   -> HttpStatus.FORBIDDEN;
            ...
            case "APPT-001"   -> HttpStatus.NOT_FOUND;
            case "APPT-002"   -> HttpStatus.BAD_REQUEST;
            case "APPT-003"   -> HttpStatus.CONFLICT;
            case "VEH-001"    -> HttpStatus.NOT_FOUND;
            case "VEH-002"    -> HttpStatus.FORBIDDEN;
            case "VEH-003"    -> HttpStatus.CONFLICT;
